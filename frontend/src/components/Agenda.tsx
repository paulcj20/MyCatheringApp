...
const Agenda = () => {
    ...
    return (
        <section id="agenda" className="py-16 md:py-24 bg-primary-50 relative overflow-hidden">
            {/* Decorative bg element */}
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-accent-100 rounded-full mix-blend-multiply filter blur-3xl opacity-50 z-0"></div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                    <h2 className="text-sm md:text-base text-accent-600 font-semibold tracking-wide uppercase">Reservas</h2>
                    <p className="mt-2 text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 font-serif">
                        Agenda Online
                    </p>
                ...
                <div className="lg:grid lg:grid-cols-5 lg:gap-12 items-start">
                    ...
                    >
                        <h3 className="text-2xl font-bold text-gray-900 font-serif mb-6">¿Por qué elegirnos?</h3>
                        <ul className="space-y-6">
                            <li className="flex">
                                ...
                                <div className="ml-4">
                                    <h4 className="text-lg font-medium text-gray-900">Experiencia Única</h4>
                                    <p className="mt-1 text-gray-500">Diseñamos cada menú y ambientación a medida.</p>
                                </div>
                            </li>
                            <li className="flex">
                                <span className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full bg-accent-100 text-accent-600">
                                ...
                                <div className="ml-4">
                                    <h4 className="text-lg font-medium text-gray-900">Puntualidad Perfecta</h4>
                                    <p className="mt-1 text-gray-500">Cronograma ajustado al minuto para su tranquilidad.</p>
                                </div>
                            </li>
                            <li className="flex">
                                <span className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-full bg-accent-100 text-accent-600">
                                ...
                                <div className="ml-4">
                                    <h4 className="text-lg font-medium text-gray-900">Staff Profesional</h4>
                                    <p className="mt-1 text-gray-500">Camareros y chefs de primer nivel.</p>
                                </div>
                            </li>
                        </ul>
                    </motion.div>
                    ...
                    <motion.div
                        ...
                        whileInView={{ opacity: 1, x: 0 }}
                        viewport={{ once: false, amount: 0.25 }}
                        className="lg:col-span-3 bg-white rounded-2xl shadow-2xl p-6 md:p-10 border border-gray-100"
                    >
                        <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="relative">
                                    ...
                                    <div className="relative rounded-md shadow-sm">
                                        ...
                                        <input
                                            ...
                                            id="clientName"
                                            required
                                            className="block w-full pl-10 rounded-lg border-gray-300 shadow-sm focus:border-accent-500 focus:ring-accent-500 p-3 border"
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    <label htmlFor="eventTime" className="block text-sm font-medium text-gray-700 mb-1">Hora (Aprox)</label>
                                    <div className="relative rounded-md shadow-sm">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                <div>
                                    <label htmlFor="guestCount" className="block text-sm font-medium text-gray-700 mb-1">Invitados</label>
                                    <div className="relative rounded-md shadow-sm">
                                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <div>
                                    ...
                                    <select
                                        id="eventType"
                                        className="block w-full rounded-lg border-gray-300 shadow-sm focus:border-accent-500 focus:ring-accent-500 p-3 border"
                            ...
                            <div>
                                <label htmlFor="message" className="block text-sm font-medium text-gray-700 mb-1">Detalles Adicionales</label>
                                <div className="relative rounded-md shadow-sm">
